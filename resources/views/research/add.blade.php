...
<div id="flash_message"></div>
		...
		<!-- Form to gather user data -->
				...
				<br>
						...
						<p>Please indicate if you are submitting a <span class="bold">PAPER</span> or <span class="bold">POSTER</span>:   <select form="research_form" name="paper_poster" value='select'>
